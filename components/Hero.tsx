  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-transparent py-16 md:py-24">
      ...
      <div ref={contentRef} className="relative z-10 w-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        {/* Headline */}
        <h1
          className={`text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 md:mb-4 leading-tight transition-all duration-700 ${
        ...
        <p
          className={`text-center text-base md:text-lg text-white/90 mb-8 md:mb-10 max-w-2xl transition-all duration-700 delay-100 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
